...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Super>r")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Shift><Super>r")
...
; (gtk_accel_path "<Actions>/TerminalWindow/shortcuts" "")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Shift><Super>c")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Super>c")
